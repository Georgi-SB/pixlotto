	...
	<body id="pageBody">
		<div id="divBoxed" class="container">
		    ...
		    <div class="headerArea">
			    ...
			    <div class="pull-right">
			    	Switch language: 
			    	<a href="main?show=menu2&lang=en"><img src="img/us.png" /></a>&nbsp;
			    	<a href="main?show=menu2&lang=de"><img src="img/de.png" /></a>&nbsp;
			    	<a href="main?show=menu2&lang=bg"><img src="img/bg.png" /></a>&nbsp;
			    </div>
	            </div>
	        </div>
		    <div class="contentArea">
			    <div class="contentArea">
			        <div class="divPanel notop page-content" id="divMain">
			    	  <h1><%= request.getAttribute( "menu2_title" ) %></h1>
			    	  <p><%= request.getAttribute( "menu2_text" ) %></p>
			    	</div>
			    </div>
		    </div>
