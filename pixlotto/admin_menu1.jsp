    ...
    <div class="container">
	    ...
	    <div class="container span3">
		    <ul class="nav nav-list">
			    ...
			    <li class="active"><a href="/pixlotto/admin?nav=menu1&lang=<%= request.getAttribute( "lang" ) %>">What is it good for</a></li>
	    ...
	    <div class="container span9">
			<div class="container-fluid">
				<form method="post" action="/pixlotto/admin">
       				...
       				<input type="hidden" name="op" value="menu1">
				    ...
				    <div id="feedback"><font color="<%= request.getAttribute( "color" ) %>"><%= request.getAttribute( "message" ) %></font></div>
       				...
       				<div class="row-fluid">
						<div class="span12">
							<h4>What is it good for&nbsp;&nbsp;&nbsp;
						    <a href="/pixlotto/admin?nav=menu1&lang=en"><img src="img/us.png" /></a>&nbsp;
						    <a href="/pixlotto/admin?nav=menu1&lang=de"><img src="img/de.png" /></a>&nbsp;
						    <a href="/pixlotto/admin?nav=menu1&lang=bg"><img src="img/bg.png" /></a>&nbsp;
						    </h4><br>
						</div>
					</div>
       				<div class="row-fluid">
						<div class="span12">
							<b>Title</b><br>
							<input type="text" class="input-xxlarge" name="menu1_title" value="<%= request.getAttribute( "menu1_title" ) %>">
						</div>
					</div>
       				<div class="row-fluid">
						<div class="span12">
							<b>Text</b><br>
							<textarea class="input-xxlarge" name="menu1_text" rows="20"><%= request.getAttribute( "menu1_text" ) %></textarea>
						</div>
					</div>
        			<div class="row-fluid">
