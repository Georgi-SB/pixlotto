...
public final class admin_005fhomepage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if ( username.equals( "none" ) ) response.sendRedirect( "admin.jsp" );
      ...
      out.write("\t    \t<a href=\"/pixlotto/admin?nav=home&lang=en\"><img src=\"img/us.png\" /></a>&nbsp;\r\n");
      out.write("\t    \t<a href=\"/pixlotto/admin?nav=home&lang=de\"><img src=\"img/de.png\" /></a>&nbsp;\r\n");
      out.write("\t    \t<a href=\"/pixlotto/admin?nav=home&lang=bg\"><img src=\"img/bg.png\" /></a>&nbsp;\r\n");
      out.write("\t    </div><br>\r\n");
      out.write("\t    <hr>\r\n");
      out.write("\t    <div class=\"container span3\">\r\n");
      out.write("\t\t    <ul class=\"nav nav-list\">\r\n");
      out.write("\t\t\t    <li class=\"nav-header\">Choose template to edit</li>\r\n");
      out.write("\t\t\t    <li class=\"active\"><a href=\"/pixlotto/admin?nav=home&lang=");
      out.print( request.getAttribute( "lang" ) );
      out.write("\">Homepage</a></li>\r\n");
      out.write("\t\t\t    <li><a href=\"/pixlotto/admin?nav=menu1&lang=");
      out.print( request.getAttribute( "lang" ) );
      out.write("\">What is it good for</a></li>\r\n");
      out.write("\t\t\t    <li><a href=\"/pixlotto/admin?nav=menu2&lang=");
      out.print( request.getAttribute( "lang" ) );
      ...
      out.write("       \t\t\t\t<input type=\"hidden\" id=\"lang\" name=\"lang\" value=\"");
      out.print( request.getAttribute( "lang" ) );
      out.write("\">\r\n");
      out.write("       \t\t\t\t<input type=\"hidden\" name=\"op\" value=\"homepage\">\r\n");
      out.write("       \t\t\t\t");
 if ( request.getAttribute( "color" ) != null && request.getAttribute( "message" ) != null ) { 
      ...
      out.write("\t\t\t\t\t\t<div class=\"span10\"><input type=\"text\" class=\"input-xxlarge\" name=\"slogan\" value=\"");
      out.print( request.getAttribute( "slogan" ) );
      out.write("\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("        \t\t\t<div class=\"row-fluid\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span2\">Top Text</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span10\"><textarea class=\"input-xxlarge\" name=\"top_text\" rows=\"7\">");
      out.print( request.getAttribute( "top_text" ) );
      out.write("</textarea></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("        \t\t\t<div class=\"row-fluid\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span2\">Choose image</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span10\"><input type=\"text\" class=\"input-xxlarge\" name=\"choose_image\" value=\"");
      out.print( request.getAttribute( "choose_image" ) );
      out.write("\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("        \t\t\t<div class=\"row-fluid\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span2\">Choose date</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span10\"><input type=\"text\" class=\"input-xxlarge\" name=\"choose_date\" value=\"");
      out.print( request.getAttribute( "choose_date" ) );
      out.write("\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("        \t\t\t<div class=\"row-fluid\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span2\">Choose lotto</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span10\"><input type=\"text\" class=\"input-xxlarge\" name=\"choose_lotto\" value=\"");
      out.print( request.getAttribute( "choose_lotto" ) );
      out.write("\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("        \t\t\t<div class=\"row-fluid\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span2\">Main button</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span10\"><input type=\"text\" class=\"input-xxlarge\" name=\"main_button\" value=\"");
      ...
      out.write("\t\t\t\t\t\t<div class=\"span10\"><input type=\"text\" class=\"input-xxlarge\" name=\"menu1\" value=\"");
      out.print( request.getAttribute( "menu1" ) );
      out.write("\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("        \t\t\t<div class=\"row-fluid\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span2\">Menu 2</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span10\"><input type=\"text\" class=\"input-xxlarge\" name=\"menu2\" value=\"");
      out.print( request.getAttribute( "menu2" ) );
      out.write("\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("        \t\t\t<div class=\"row-fluid\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span2\">Menu 3</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span10\"><input type=\"text\" class=\"input-xxlarge\" name=\"menu3\" value=\"");
      ...
      out.write("\t\t\t\t\t\t<div class=\"span10\"><input type=\"text\" class=\"input-xxlarge\" name=\"congrats\" value=\"");
      out.print( request.getAttribute( "congrats" ) );
      out.write("\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("        \t\t\t<div class=\"row-fluid\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span2\">Go get lucky</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span10\"><input type=\"text\" class=\"input-xxlarge\" name=\"go_get_lucky\" value=\"");
      out.print( request.getAttribute( "go_get_lucky" ) );
      out.write("\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("        \t\t\t<div class=\"row-fluid\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span2\">Affilliates</div>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t        </select><br>\r\n");
      out.write("\t\t\t\t\t\t\t<textarea class=\"input-xxlarge\" id=\"affilliates\" name=\"affilliates\" rows=\"7\">");
      out.print( request.getAttribute( "affilliates_DE" ) );
      out.write("</textarea>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("        \t\t\t<div class=\"row-fluid\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span2\">Play now</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"span10\"><input type=\"text\" class=\"input-xxlarge\" name=\"play_now\" value=\"");
      ...
      out.write("\t\t$( \"#lottoland\" ).change( function() {\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\ttype: \"POST\",\r\n");
      out.write("\t\t\t\turl: \"adminJSON\",\r\n");
      out.write("\t\t\t\tdata: { lang: $( \"#lang\" ).val(), land: $( \"#lottoland\" ).val() }\r\n");
      out.write("\t\t\t})\r\n");
      out.write("\t\t\t.done(function( rsp ) {\r\n");
      out.write("\t\t\t\t$( \"#affilliates\" ).text( rsp );\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      out.write("    </script>\r\n");
      out.write("\t</body>\r\n");
