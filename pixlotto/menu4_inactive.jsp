	    ...
	    <div class="navbar">
	      <div class="navbar-inner">
	        ...
	        <ul class="nav pull-right">
	          <li><a href="/" class="active"><%= request.getAttribute( "slogan" ) %></a></li>
	        </ul>
	      </div>
	    </div>
	    <div align="justify">
	    	  <h3 align="center"><%= request.getAttribute( "menu4" ) %></h3>
	    	  <p><%= request.getAttribute( "menu4_text" ) %></p>
	    </div>
		<hr>
	    <div align="center">
	 	  <p>
	 	  	<a href="main?lang=<%= request.getAttribute( "lang" ) %>">
	 	  		<button onclick="submitForm()" class="btn btn-large btn-success"><%= request.getAttribute( "main_button" ) %></button>
	 	  	</a>
	      <p>
	        ...
	        <a href="main?show=menu3&lang=<%= request.getAttribute( "lang" ) %>"><button class="btn btn-lg btn-primary"><%= request.getAttribute( "menu3" ) %></button></a>
	        <a href="main?show=menu4&lang=<%= request.getAttribute( "lang" ) %>"><button class="btn btn-lg btn-warning"><%= request.getAttribute( "menu4" ) %></button></a>
	      </p>
	    </div>
	</body>
</html>